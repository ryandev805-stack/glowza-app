...
export function Modal({ title, children, onClose, wide = false, full = false, panelRef }) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-end bg-black/35 p-0 sm:place-items-center sm:p-5">
      <div
        ref={panelRef}
        className={`max-h-[96dvh] w-full overflow-auto rounded-t-[2rem] bg-white p-4 shadow-2xl sm:max-h-[94vh] sm:rounded-[2rem] sm:p-5 ${sizeClass}`}
      >
